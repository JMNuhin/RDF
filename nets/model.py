...
from nets.task_modules import SeverityHead, MultiScaleSpatialWeights
...
class YoloBody(nn.Module):
    def __init__(self, anchors_mask, num_classes, use_task_heads=True):
    ...
    def forward(self, x):
        ...
        if self.training:
            if self.use_task_heads:
                ...
                # Compute spatial weights from neck features
                ...
                # Return: detections, dehazing, neck features, severity, spatial weights
                return {
                    'detections': [out0, out1, out2],
                    'dehazing': dehazing,
                    'neck_features': [neck_features_P3, neck_features_P4, neck_features_P5],
